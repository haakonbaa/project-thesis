...
This chapter delves into the mathematical modeling of light-UVMSs. Starting with the foundational 
principles of rigid body dynamics, the chapter expands into the kinematic and 
dynamic modeling of articulated underwater vehicles, highlighting the coupling 
...
Before modeling a general UVMS with multiple links, we will model
